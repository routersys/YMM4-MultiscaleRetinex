...
internal static class MultiscaleRetinexUpdateNotifier
{
    private const string Owner = "routersys";
    private const string Repository = "YMM4-MultiscaleRetinex";
    ...
    private static async Task RunAsync()
    {
        try
        {
            ...
            {
                CurrentVersion = PluginVersion.FromAssemblyInformationalVersion(typeof(MultiscaleRetinexUpdateNotifier)),
    ...
    private static Task ShowNotificationAsync(UpdateNotification notification, CancellationToken cancellationToken)
    {
        ...
        return application.Dispatcher.InvokeAsync(() =>
            MessageBox.Show(notification.Message, Texts.MultiscaleRetinex, MessageBoxButton.OK, MessageBoxImage.Information)).Task;
    }
}
