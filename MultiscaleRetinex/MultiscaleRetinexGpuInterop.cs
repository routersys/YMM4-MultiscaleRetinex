...
internal sealed class MultiscaleRetinexGpuInterop : IDisposable
{
    ...
    private MultiscaleRetinexGpuInterop(
    ...
    public static unsafe MultiscaleRetinexGpuInterop? TryCreate(IGraphicsDevicesAndContext devices)
    {
        ...
        try
        {
            ...
            return new MultiscaleRetinexGpuInterop(device, d3dDevice, d3dContext, fence, renderContext, d3d12Fence);
        }
        catch
        {
